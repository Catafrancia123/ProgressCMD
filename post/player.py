...
def settings(systemname, systemlevel, systempro, systemlogo):
    clear()
    rprint(sett)
    choise = input("> ")
    if choise == "1":
...
def mainMenu(systemname, systemlevel, systempro, systemlogo,  mail : bool = "nothing"):
    ...
    if mail == False:
        ...
        if choisce.lower() == "s":
            ...
            if choice == "1":
                ...
                if systemlevel > 1:
                    ...
                    settings(systemname, systemlevel, systempro, systemlogo)
            elif choice == "3":
                if systemlevel > 1:
                    settings(systemname, systemlevel, systempro, systemlogo)
                else:
        ...
        if choisce.lower() == "s":
            ...
            binpet(systemname, systemlevel, systempro, systemlogo)
        else:
            print(lang.comingsoon)
            sleep(3)
            mainMenu(systemname, systemlevel, systempro, systemlogo) 
